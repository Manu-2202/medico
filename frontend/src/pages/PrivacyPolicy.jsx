...
const PrivacyPolicy = () => {
  return (
    <div>
      <SEO 
        title="Privacy Policy - Medico Overseas Data Protection"
        description="Official Privacy Policy of Medico Overseas: How we collect, store, and protect student and parent inquiry data with 100% confidentiality."
      />
